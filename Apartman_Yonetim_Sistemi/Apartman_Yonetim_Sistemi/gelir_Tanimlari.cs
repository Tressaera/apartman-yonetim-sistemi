...
namespace Apartman_Yonetim_Sistemi
{
    public partial class gelir_Tanimlari : Form
    {
        ...
        {
            // TODO: Bu kod satırı 'apartmanDataSet3.gelirler' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.gelirlerTableAdapter.Fill(this.apartmanDataSet3.gelirler);
            gelir();
            combodoldur();
        }
