...
namespace Apartman_Yonetim_Sistemi
{
    public partial class Apart_Yonetici_Borclari : Form
    {
        ...
        {
            // TODO: Bu kod satırı 'apartmanDataSet4.borclar' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.borclarTableAdapter.Fill(this.apartmanDataSet4.borclar);
            odedigim();
            borclarim();
        }
