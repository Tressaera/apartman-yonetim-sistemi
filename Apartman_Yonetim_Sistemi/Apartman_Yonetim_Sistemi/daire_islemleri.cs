...
namespace Apartman_Yonetim_Sistemi
{
    public partial class daire_islemleri : Form
    {
        ...
        {
            // TODO: Bu kod satırı 'apartmanDataSet2.daire' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.daireTableAdapter.Fill(this.apartmanDataSet2.daire);
            doldurApartman();
            daire();
        }
