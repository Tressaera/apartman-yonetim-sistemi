...
namespace Apartman_Yonetim_Sistemi
{
    public partial class Loglar : Form
    {
        ...
        {
            // TODO: Bu kod satırı 'apartmanDataSet.log' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.loggTableAdapter.Fill(this.apartmanDataSet.logg);
            LOG();
        }
    }
}
