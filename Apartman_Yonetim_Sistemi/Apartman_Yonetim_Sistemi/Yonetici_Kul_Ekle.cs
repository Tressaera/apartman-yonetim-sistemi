    ...
    public partial class Yonetici_Kul_Ekle : Form
    {
        ...
        private void button15_Click(object sender, EventArgs e)
        {
            if (textBox29.Text==textBox30.Text)
            {
                ...
                komut = new SqlCommand("insert into kullanic(tc_no,ad,soyisim,email,telefon,daire_no,ev_durumu,rol,sifre,apartman_id) values('" + maskedTextBox2.Text + "','" + textBox25.Text + "','" + textBox26.Text + "','" + textBox27.Text + "','" + maskedTextBox3.Text + "','" + combo_daire_no.Text + "','" + comboBox6.Text + "','" + comboBox7.Text + "','" + sifrelisifre + "','" + secili_apartman_id + "')", bag.baglan());
