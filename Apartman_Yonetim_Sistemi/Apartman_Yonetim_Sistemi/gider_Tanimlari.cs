...
namespace Apartman_Yonetim_Sistemi
{
    public partial class gider_Tanimlari : Form
    {
        ...
        {
            // TODO: Bu kod satırı 'apartmanDataSet1.giderler' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.giderlerTableAdapter.Fill(this.apartmanDataSet1.giderler);
            gider();
            doldurborctipi();
        }
        ...
        private void button7_Click_1(object sender, EventArgs e)
        {
            ...
            SqlCommand log = new SqlCommand("insert into logg(islem,ip,tc,aciklama,tarih)values('" + "Gider Silme" + "','" + Dns.GetHostByName(bilgisayarAdi).AddressList[0].ToString() + "','" + Form1.giris + "','" + "" + "','" + DateTime.Now.ToString() + "')", baglan.baglan());
            log.ExecuteNonQuery();
